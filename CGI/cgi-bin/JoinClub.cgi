...
print MAIL "NEW MESSAGE\n";
print MAIL "AHHHHHHH\n";
print MAIL "Call me maybe? $tel ;)";
close(MAIL);
...
<p>Welcome to club.com.  Your membership will be processed shortly.</p>
<p>We will email you at <code>$email</code> about your new membership at $club.</p>
<p>We will call you sometime @ $tel</p>
</body></html>
END
#######################################
sub error() 
